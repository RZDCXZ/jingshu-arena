...
async function main() {
  ...
  const testFiles = requestedTestFiles.length
    ...
    : [
        ...
        "packages/database/tests/manager-store-configuration.integration.test.ts",
        "packages/database/tests/manager-people-schedule.integration.test.ts",
        "packages/database/tests/manager-dashboard.integration.test.ts",
        "packages/database/tests/staff-reservation-operations.integration.test.ts",
        "packages/database/tests/staff-shift-attendance.integration.test.ts",
        "packages/database/tests/staff-handover.integration.test.ts",
        ...
        "apps/api/src/staff-shift.integration.test.ts",
        "apps/api/src/staff-handover.integration.test.ts",
