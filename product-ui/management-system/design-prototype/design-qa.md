...
- 状态：`current`（当前有效）
- 检查日期：2026-08-10
- 已验证契约版本：`product-ui/management-system/prod.md` 1.4
- 验证范围：[`09 — 店员办理到店、使用与完成预约`](../../../.scratch/jingshu-basic-rc/issues/09-staff-reservation-operations.md)；保留 ticket 08 预约支付、生命周期与模拟退款和更早结论
