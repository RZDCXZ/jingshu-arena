...
- 状态：`current`（当前有效）
- 检查日期：2026-08-10
- 已验证契约版本：`product-ui/management-system/prod.md` 1.3
- 验证范围：[`07 — 预约待确认、冲突约束与价格/体验券快照`](../../../.scratch/jingshu-basic-rc/issues/07-reservation-hold-snapshot.md)；保留 ticket 06 三店浏览、座位可订性与价格预览及更早结论
